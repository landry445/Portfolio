      ...
      <div>
        ...
        >
          <motion.div
            ...
            "
            initial={{ opacity: 0, scale: 0.5 }}
            animate={isInViewFirst ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.5 }}
            transition={{
              duration: 0.5,
              delay: 0.1,
              ease: [0, 0.71, 0.2, 1.01]
          ...
          >
            ...
            >
              Je maîtrise des fondamentaux HTML, CSS, JavaScript.<br />
              utilise&#160;
              <span className={`
                ...
                `}>
                React
              </span> pour interface utilisateur,&#160;
              <span className={`
                  custom-font-secondary 
                  text-[1.125rem]
                `}>
          ...
          <motion.div
            ...
            className="
              ...
              "
            initial={{ opacity: 0, scale: 0.5 }}
            animate={isInViewSecond ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.5 }}
            transition={{
              duration: 0.5,
          ...
          <motion.div
            ...
            className="
              ...
              "
            initial={{ opacity: 0, scale: 0.5 }}
            animate={isInViewThird ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.5 }}
            transition={{
              duration: 0.5,
          ...
          >
            ...
            >
              ...
              <span className={`
                ...
                `}>
                DALL·E
              </span>&#160; pour m'assister dans l’optimisation de mon workflow, le développement et la création d'image.
            </SkillsCard>
          </motion.div>
        </div>
      </div>
